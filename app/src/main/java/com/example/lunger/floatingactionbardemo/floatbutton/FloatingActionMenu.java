package com.example.lunger.floatingactionbardemo.floatbutton;
...
import com.example.lunger.floatingactionbardemo.R;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private void addLabel(FloatingActionButton fab) {
        ...
        //todo 强行设置label背景圆角
        label.setBackgroundResource(R.drawable.white_bg_corner);
